...
async function sendPushToUser(uid, notification, data = {}) {
    try {
        ...
        console.log(`Push sent to ${uid}: ${response.successCount} success, ${response.failureCount} failures`);
    } catch (error) {
...
exports.onNewChallenge = functions.firestore
    ...
    .onCreate(async (snap, context) => {
        ...
        const promises = membersSnap.docs
            ...
            .map(memberDoc => {
                return sendPushToUser(memberDoc.id, {
...
exports.dailyReminder = functions.pubsub
    ...
    .onRun(async () => {
        ...
        const promises = usersSnap.docs.map(async (userDoc) => {
            ...
            return sendPushToUser(userDoc.id, {
                title: '⚡ PROJET FEVRIER',
